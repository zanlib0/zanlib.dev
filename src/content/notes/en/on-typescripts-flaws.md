...
I specifically did not want to go for the low-hanging fruit of issues with tooling surrouding TS. There are a lot of it there - it's very easy to complain about slow compilation with `tsc` or crazy memory usage of `tsserver`. Every piece of tooling [comes with a cost](/posts/solid-anew).
