...
Let's leave the problem of eternal uncertainty aside for a moment and move into the realm of perfect information: the game of chess.

While chess is an extremely computationally complex game with trillions of permutations for pretty much every possible move, it is still significantly less complicated than the real world, the times in which we live and the decisions we have to make every day. With the perfect information, a chess grandmaster has to think many moves ahead—a feat many inexperienced players are incapable of.
...
That's why, personally, I prefer poker. Poker is not entirely rational, even though it also has a strict structure, repeating models and simple rules. In the words of Martin Amis, "on a chessboard, the properties and powers of a bishop are fixed. In poker, it's all wobbled through the prism of personality." And besides, it's a whole lot more fun to watch than chess.[+mahjong]

[+mahjong]: While this was true when I wrote the article, these days I would say that I much prefer [riichi mahjong](https://en.wikipedia.org/wiki/Japanese_mahjong) as a reasonable stepping stone between poker and chess as far as chance versus strategy is concerned. Unfortunately, for most, the mention of "mahjong" evokes the idea of a [tile matching game](https://en.wikipedia.org/wiki/Mahjong_solitaire).
