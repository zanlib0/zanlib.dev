...
The news rely on us not trusting our friends. The internet rationalists say that the information one gets from a friend is "anecdotal" and "unreliable". However, the news one gets from pundits on the internet are "fact-checked" and "trustworthy". We read them, we suffer from [Gell-Mann amnesia](https://www.goodreads.com/quotes/65213-briefly-stated-the-gell-mann-amnesia-effect-is-as-follows-you), and then we trust them.
